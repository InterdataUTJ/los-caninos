...
<head>
  ...
  <title>Editar empleado #<?= $empleado->getId(); ?></title>
...
<body class="d-flex flex-column container-fluid m-0 p-0">
  ...
  <main class="container flex-grow-1 d-flex flex-column h-100 mx-auto p-3 gap-3" style="max-width: 1000px;">
    <h2 class="fw-bold pb-2 mb-3" style="border-bottom: 2px solid #fcbc73;">Editar empleado #<?= $empleado->getId(); ?></h2>
    ...
    <form onsubmit="enviarDatos(event);" action="/controllers/empleados/editar/" method="POST">
      <div class="d-flex gap-3">
        <div class="mb-3 flex-grow-1">
          ...
          <input type="number" class="form-control disabled" name="id" id="id" value="<?= $empleado->getId(); ?>" readonly onclick='return false;'>
        </div>
        <div class="mb-3 flex-grow-1">
          <label class="form-label fw-bold" for="idUsuario">Id de Usuario</label>
          <input type="number" class="form-control disabled" name="idUsuario" id="idUsuario" value="<?= $empleado->getIdUsuario(); ?>" readonly onclick='return false;'>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" name="nombre" id="nombre" class="form-control" value="<?= $empleado->getNombre(); ?>">
      ...
      <div class="d-flex gap-3">
        <div class="mb-3 flex-grow-1">
          ...
          <input type="text" class="form-control" id="apellidoPaterno" name="apellidoPaterno" value="<?= $empleado->getApellidoPaterno(); ?>">
        ...
        <div class="mb-3 flex-grow-1">
          ...
          <input type="text" class="form-control" id="apellidoMaterno" name="apellidoMaterno" value="<?= $empleado->getApellidoMaterno(); ?>">
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" name="fechaNac" id="fechaNac" value="<?= $empleado->getFechaNac(); ?>">
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="input-group mb-3">
          ...
          <input type="number" class="form-control" id="salario" name="salario" value="<?= $empleado->getSalario(); ?>">
      ...
      <div data-mdb-input-init class="mb-3 form-outline">
        ...
        <select class="form-select" id="estado" aria-label="estado" name="estado">
          <option value="ACTIVO" <?= $empleado->getEstatus() == "ACTIVO" ? "selected" : ""; ?>>ACTIVO</option>
          <option value="INACTIVO" <?= $empleado->getEstatus() == "INACTIVO" ? "selected" : ""; ?>>INACTIVO</option>
        </select>
      </div>
      ...
      <div data-mdb-input-init class="mb-3 form-outline">
        ...
        <select class="form-select" id="rol" aria-label="rol" name="rol">
          <option value="GERENTE" <?= $empleado->getRol() == "GERENTE" ? "selected" : ""; ?>>GERENTE</option>
          <option value="VETERINARIO" <?= $empleado->getRol() == "VETERINARIO" ? "selected" : ""; ?>>VETERINARIO</option>
        </select>
      </div>
