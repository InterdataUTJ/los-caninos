...
<head>
  ...
  <title>Editar servicio #<?= $_GET["id"] ?></title>
...
<body class="d-flex flex-column container-fluid m-0 p-0">
  ...
  <main class="container flex-grow-1 d-flex flex-column h-100 mx-auto p-3 gap-3" style="max-width: 1000px;">
    <h2 class="fw-bold pb-2 mb-3" style="border-bottom: 2px solid #fcbc73;">Editar servicio #<?= $_GET["id"] ?></h2>
    ...
    <form onsubmit="enviarDatos(event);" action="/controllers/mascotas/nuevo/" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="number" class="form-control disabled" name="idFactura" id="idFactura" value="<?= $_GET["id"]; ?>" readonly>
      </div>
      ...
      <div class="mb-3">
        ...
        <input type="date" class="form-control" name="fechaPago" id="fechaPago" value="<?= $factura->getFechaPago(); ?>">
      ...
      <?php foreach($factura->getServicios() as $servicio) : ?>
        <details id='<?= $servicio->getId(); ?>-servicio-id' class="mb-4 mx-3 p-3 rounded border nuevo-servicio" style="background-color: #fcfcfc;">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control disabled" name="idServicio" value="<?= $servicio->getId(); ?>" readonly>
          </div>
          ...
          <div data-mdb-input-init class="form-outline mb-3" id="<?= $empleadoRandId ?>-container-id">
            ...
            <?php foreach ($servicio->getIdEmpleados() as $idEmpleado) : ?>
              <div class="input-group mb-3" id="<?= $empleadoRandId."-".$idEmpleado ?>-empleado-id">
                ...
                <button class="btn btn-outline-danger" type="button" onclick="document.getElementById('<?= $empleadoRandId.'-'.$idEmpleado ?>-empleado-id').remove();">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="diagnostico" id="diagnostico" placeholder="Diagnostico" value="<?= $servicio->getDiagnostico(); ?>">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tratamiento" id="tratamiento" placeholder="Tratamiento" value="<?= $servicio->getTratamiento(); ?>">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" name="fechaIngreso" id="fechaIngreso" value="<?= $servicio->getFechaIngreso(); ?>">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" name="fechaSalida" id="fechaSalida" value="<?= $servicio->getFechaSalida(); ?>">
