  ...
  <div class="offcanvas-body">
    <div>
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="filter-mascota-tamano-pequeno" 
          <?php if (in_array("PEQUEÑO", $_GET["filterTamano"])) echo "checked"; ?>
        >
        <label class="form-check-label" for="filter-mascota-tamano-pequeno">Pequeño</label>
      </div>

      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="filter-mascota-tamano-mediano" 
          <?php if (in_array("MEDIANO", $_GET["filterTamano"])) echo "checked"; ?>
        >
        <label class="form-check-label" for="filter-mascota-tamano-mediano">Mediano</label>
      </div>

      <div class="form-check">
        <input class="form-check-input" type="checkbox" id="filter-mascota-tamano-grande" 
          <?php if (in_array("GRANDE", $_GET["filterTamano"])) echo "checked"; ?>
        >
        <label class="form-check-label" for="filter-mascota-tamano-grande">Grande</label>
      </div>
...
<script>
  ...
  const filters = {
    "filterTamano": {
      "PEQUEÑO": "filter-mascota-tamano-pequeno",
      "MEDIANO": "filter-mascota-tamano-mediano",
      "GRANDE": "filter-mascota-tamano-grande"
    },
